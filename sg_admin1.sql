...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 30, 2023 lúc 01:13 PM
...
INSERT INTO `chat` (`id_chat`, `id_user`, `noidung`, `ngaychat`) VALUES
(4, 1, 'a', '2023-11-30 10:41:04'),
(16, 1, 'a', '2023-11-30 12:02:04'),
(17, 1, 'a', '2023-11-30 12:04:30'),
(18, 1, 'a', '2023-11-30 12:04:36');
...
CREATE TABLE `chatchitiet` (
  `id_chatct` int(11) NOT NULL,
  `id_user` int(11) NOT NULL,
  `noidung_admin` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `chatchitiet`
--

INSERT INTO `chatchitiet` (`id_chatct`, `id_user`, `noidung_admin`) VALUES
(1, 1, 'abc');
...
ALTER TABLE `chatchitiet`
  ADD PRIMARY KEY (`id_chatct`),
  ADD KEY `chatct_user` (`id_user`);
...
--
ALTER TABLE `chatchitiet`
  MODIFY `id_chatct` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `ct_donhang`
--
ALTER TABLE `ct_donhang`
  MODIFY `id_ctdh` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `chat`
  ADD CONSTRAINT `chat_user` FOREIGN KEY (`id_user`) REFERENCES `khachhang` (`id_kh`);

--
-- Các ràng buộc cho bảng `chatchitiet`
--
ALTER TABLE `chatchitiet`
  ADD CONSTRAINT `chatct_user` FOREIGN KEY (`id_user`) REFERENCES `khachhang` (`id_kh`);
