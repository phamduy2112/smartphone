...
$dangnhapmb.='  
<a href="?mod=user&act=thongtinchitiet" class="d-flex align-items-center ">
<i class="fa fa-user" aria-hidden="true" class=""></i>
<div class="icon_item_text mx-2" >
'.$_SESSION['taikhoan'].'
</div>
</a>';
;
...
;
  $dangnhapmb.='               
   <a href="?mod=user&act=dangnhap" class="d-flex align-items-center">
  <i class="fa fa-user" aria-hidden="true"></i>
  <div class="icon_item_text mx-2">
  Đăng nhập ngay
  </div>
...
<head>
  ...
  <title><?=$title?></title>
  <link rel="icon" type="image/png" href="../content/img/icon/LOGO_2.png">
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<header>
    <div class="header__top">
      <div class="container header__top_item text-center">
        ...
        <?=$taikhoan?>
          <a href="" style="margin-left: 30px;" class="header_top_con">Định vị cửa hàng</a>
          <a href="" class="header_top_con">Câu hỏi thường gặp</a>
        ...
        <div class="container">
          <div class="header__main_top d-lg-flex">
            ...
            <form action="?mod=page&act=timkiemsp" class="form__search" method='post'>
              <input type="text" placeholder="Tìm kiếm sản phẩm" class="search" name='key' required title="Hãy nhập gì đó">
        ...
        <div class="container d-lg-flex justify-content-between">
          ...
          <nav class="menu__item">
            <ul>
              ...
              <li><a href="?mod=page&act=blog">Blog</a></li>
              <li><a href="?mod=page&act=chat">Nhắn tin</a></li>
              <li><a href="?mod=page&act=lienhe">Liên hệ</a></li>
            </ul>
          </nav>
