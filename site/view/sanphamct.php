...
<link rel="stylesheet" href="../content/css/productct.css">
<main>
    <!-- product left -->
    <div class="productct">
        ...
        <div class="container-md">
            ...
            <div class="productct__flex row mt-3">
                <div class="productct__left col-lg-6 col-sm-12">
                    ...
                    <div class="img_big">
                        <img class="img-thumbnail w-100" src="../content/img/product_tachnen/<?=$hinhanh?>" alt="" id='big_img'>
                    </div>

                    <div class="pro_img mt-2">
                    <div class="img_small">
                            <img class="img-thumbnail" src="../content/img/product_tachnen/<?=$hinhanh?>" alt="" id="small_img">
                        </div>
                        <div class="img_small">
                            <img class="img-thumbnail" src="../content/img/productchitiet/<?=$anh1?>" alt="" id="small_img">
                        </div>
                      
                        <div class="img_small">
                            <img class="img-thumbnail" src="../content/img/productchitiet/<?=$anh2?>" alt="" id="small_img">
                        </div>
                        <div class="img_small">
                            <img class="img-thumbnail" src="../content/img/productchitiet/<?=$anh3?>" alt="" id="small_img">
                        </div>
                        <div class="img_small">
                            <img class="img-thumbnail" src="../content/img/productchitiet/<?=$anh4?>" alt="" id="small_img">
                        </div>
                    </div>
        ...
        get_price($gia,$khuyenmai);?>
                        ...
                        <!-- BUY NOW -->
                        <a href="?mod=cart&act=trangthanhtoan&id=<?=$id_sp?>" class="btn w-100 mt-2 mua">MUA NGAY</a>
            ...
            <div class="prochitiet">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        <h4 class="cmt-title"><?=$show_cmt?></h4>
                        ...
                        <div class="binhluan">
                            <div class="bl d-flex w-75">
                                <div class="image">
                                    <img src="../content/img/service/User.png" alt="">
                                </div>
                        ...
                        <?php endforeach;?>
                        <div <?=$texty?>>
                            <p>Bạn cần mua hàng để gửi đánh giá!</p>
                        </div>
                        <div <?=$textx?>>
...
<!-- Bình Luận -->
                            ...
                            <form action="" class="BinhLuan" method="post" style="<?=$text?>" >
                                <input type="text" placeholder="Bình luận" class="binhluan1" name="noidung" autocomplete="off">
...
for (const smallImg of smallImgs) {
  smallImg.addEventListener("click", () => {
    // Lấy src của img small_img
    const src = smallImg.src;
