...
<section class="ql_sp_k">
    <form action="" method="post">
      <section class="search_ql_sp">
        <input type="text" placeholder="Mời tìm mã sản phẩm" name="ten_sp_trang_search">
        <button name="tim_kiem">
    ...
    foreach ($array_sp as $sp) : ?>
      ...
      <section class="text_ql_sp_sp">
        ...
        <div>
          ...
          <a href="?mod=user&act=xoa_sp&id=<?= $sp['id_sp'] ?>"><i class="bi bi-trash"></i> </a>
